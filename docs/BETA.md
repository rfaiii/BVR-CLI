...
./scripts/package/macos-dmg.sh v1.2.4-beta.1
```

**Installation:**
1. Download `bvr-cli_v1.2.4-beta.1_darwin_arm64.dmg`
...
2. **Build RC:**
   ```bash
   ./scripts/package/macos-dmg.sh v1.2.4-rc.1
   ```
...
2. **Build final DMG:**
   ```bash
   ./scripts/package/macos-dmg.sh v1.2.4
   ```
