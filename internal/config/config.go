...
type Options struct {
	...
	AudioVolume               string       `json:"audio_volume,omitempty" jsonschema:"description=Volume for audio notifications. Options: high (default)\\, low\\, silent.,enum=high,enum=low,enum=silent,default=high"`
